...
const customStyles = {
  ...
  const Profile = () => {
    ...
    <div className="profilepage">
        ...
        <div className="user-details">
            <div className="cover-page">
                <img src="https://img.freepik.com/premium-vector/travel-europe-landmarks-world-with-cable-carand-train_49537-18.jpg?w=2000" alt="" />
            </div>
    ...
    {userdetails && 
        ...
        <div className="user-details">
        <div id="cover">
           <img src="https://img.freepik.com/premium-vector/travel-europe-landmarks-world-with-cable-carand-train_49537-18.jpg?w=2000"   />
        </div>
        <div id="line"></div>
        <div id="circal">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTe9yWmtBD3aj_7mqHn9SVadOiSVM2Ge2TXyQ&usqp=CAU" alt="" />   
        </div>
        <button onClick={logout}>Logout</button>
